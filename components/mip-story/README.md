...
<mip-story standalone background-audio="http://mipstatic.baidu.com/static/mip-static/mip-story/story-film/videos/CliffRichardDevilWoman.mp3">
    ...
    <mip-story-view>
        ...
        <mip-story-layer>
            ...
            <p class="fade-in-down">快用 MIP 小故事开发很多丰富的交互效果吧！</p>
        </mip-story-layer>
    </mip-story-view>
    <mip-story-view>
        <mip-story-layer template="fill">
    ...
    <mip-story-view>
        ...
        <mip-story-layer>
            <h1 animate-in="fly-in-right">第三页测试</h1>
            <p class="fade-in-down">第三页CSS测试</p>
        </mip-story-layer>
    </mip-story-view>
    <mip-story-view>
        <mip-story-layer template="fill">
        ...
        <mip-story-layer>
            <h1 animate-in="fly-in-right">第四页测试</h1>
            <p class="fade-in-down">第四页CSS测试</p>
        </mip-story-layer>
    </mip-story-view>
</mip-story>
```
